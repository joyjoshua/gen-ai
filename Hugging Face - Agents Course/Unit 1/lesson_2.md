...
1. LLMs are designed in specializing to understand human language. They are trained under vast data to understand and generate human language
2. LLM's are built on Transformers architecture - a deep learning architecture based on the “Attention” algorithm
...
2. Decorders - A decoder-based Transformer focuses on generating new tokens to complete a sequence, one token at a time.
